# -*- coding: utf-8 -*-
"""Pilha validador expressão.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1K7bfqXzkNDHN5fC52VgCUhe4flcI27s-
...
class Pilha:
  def __init__(self, capacidade):
    ...
    self.topo = -1
    self.valores = np.chararray(self.capacidade, unicode=int)
